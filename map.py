...
import numpy as np
from models.resnet import resnet50_da1
from models.resnet import resnet50
"""画中间特征图"""
savepath = r'features_whitegirl/resnet50'
...
class ft_net(nn.Module):
    ...
    def __init__(self):
        ...
        model_ft = resnet50(
            pretrain_path='./models/resnet50.pth')
        self.model = model_ft
    ...
    def forward(self, x):
        if True:  # draw features or not
            ...
            draw_features(8, 8, x.cpu().numpy(), "{}/f8_layer4_3.png".format(savepath))
...
model.eval()
img = cv2.imread(r'H:\map\002922.jpg')
